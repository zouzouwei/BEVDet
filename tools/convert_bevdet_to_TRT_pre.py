...
def parse_args():
    ...
    parser.add_argument('--config',default='configs/bevdet/bevdet4d-r50-cbgs.py', help='deploy config file path')
    parser.add_argument('--checkpoint',default='checkpoint/bevdet-r50-4d-cbgs.pth', help='checkpoint file')
    parser.add_argument('--work_dir',default='tensorrt/renet50', help='work dir to save file')
    parser.add_argument(
...
def main():
    ...
    for i, data in enumerate(data_loader):
        ...
        metas = model.get_bev_pool_input((imgs[0], rots[0], trans[0], intrins[0], post_rots[0], post_trans[0], bda))
